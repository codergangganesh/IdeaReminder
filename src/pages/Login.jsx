...
export function Login() {
  ...
  const handleSocialClick = async (provider) => {
    ...
    try {
      ...
      setError(err.message || `Failed to sign in with ${provider}. Please verify OAuth configuration in InsForge.`);
      ...
      <div className="auth-viewport-wrapper">
        <div className="auth-phone-frame animate-fade-in">
          ...
          <div className="auth-header-section">
            ...
            <div className="auth-hero-split">
              <div className="auth-hero-text">
                <h1 className="auth-hero-title-big">Hello</h1>
                <div className="auth-hero-welcome">Welcome Back!</div>
          ...
          <div className="auth-card-container">
            <h2 className="auth-card-title">Login Account</h2>
            <p className="auth-card-subtitle">
              Enter your credentials to manage your captured ideas
            </p>
            ...
            {forgotSent && (
              ...
              >
                ...
                <span>Instructions sent to {email}. Check your inbox.</span>
              </div>
            )}
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column' }}>
              ...
              <div className="auth-options-row">
                <div
                  className="auth-save-password-toggle"
                  onClick={() => setSavePassword(!savePassword)}
                  role="checkbox"
                  aria-checked={savePassword}
                  tabIndex={0}
                >
                  <div className={`auth-save-password-check ${!savePassword ? 'inactive' : ''}`}>
                    {savePassword && <Check size={12} strokeWidth={3} />}
                  </div>
  ...
  /* =========================================================================
     DESKTOP VIEW (Exact match to reference, 100vh no-scroll, with Create Account option)
     ========================================================================= */
  return (
    <div
    ...
    >
      ...
      >
        ...
        {/* Top Right "New here? Create an Account" Button */}
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
      ...
      >
        ...
        <div style={{ width: '100%', maxWidth: '470px' }}>
          ...
          >
            ...
            >
              Login to <span style={{ color: '#F59E0B' }}>IdeaVault</span>
            </h2>
            <p
              style={{
                fontSize: '0.82rem',
            ...
            {forgotSent && (
              ...
              >
                ...
                <span>Reset instructions sent to {email}.</span>
              </div>
            )}
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '0.95rem' }}>
                ...
                >
                  <div
                    style={{
                      ...
                      height: '17px',
                      borderRadius: '50%',
                      backgroundColor: savePassword ? '#10B981' : '#E5E7EB',
                      display: 'flex',
                      alignItems: 'center',
                      justifyContent: 'center',
                      color: '#FFFFFF',
                  ...
                  >
                    {savePassword && <Check size={11} strokeWidth={3} />}
                  </div>
              ...
              {/* In-Card "If no account? Create an Account" Option */}
              <div
                style={{
                  textAlign: 'center',
                  marginTop: '0.2rem',
